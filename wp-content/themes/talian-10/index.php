...
<?php if(function_exists('the_views')) { the_views(); } ?> <div class="wp_plus_one_button" style="margin: 0 8px 8px 0; float:left; "><g:plusone href="<?php the_permalink(); ?>"></g:plusone></div>
